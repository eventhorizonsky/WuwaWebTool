...
<template>
  <header class="app-header">
    ...
    <a
      v-if="showBackLink"
      href="#"
      class="text-sm text-[#9aa0aa] no-underline transition-colors hover:text-[#d4b163]"
    ...
    <a
      ...
      class="text-[#9aa0aa] no-underline"
    >
    ...
    <!-- Attribution -->
    <span class="text-[10px] text-[#9aa0aa] flex-shrink-0">
      改自
      <a
    ...
    >
      <select
        class="px-2.5 py-[5px] rounded-md bg-[var(--color-ink-1)] border border-[var(--color-line)] text-sm text-[#e8edf2] min-w-[180px] max-w-[280px] outline-none focus:border-[#d4b163]"
    ...
    <button
      v-if="showExport"
      class="px-3 py-[5px] rounded-md border font-semibold text-xs cursor-pointer transition-all bg-[#d4b163] text-[#0f1115] border-[#d4b163] hover:opacity-85"
      @click="emit('export')"
    >
      导出图片
    </button>
    ...
    <div class="flex items-center gap-2 flex-shrink-0">
      <span class="text-xs text-[#9aa0aa]">
